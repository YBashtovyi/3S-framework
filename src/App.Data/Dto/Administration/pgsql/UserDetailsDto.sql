...
LEFT JOIN org_unit_staff as ous on au.employee_id = ous.employee_id and ous.record_state <> 4
LEFT JOIN org_unit_position as oup on ous.org_unit_position_id = oup.id  and oup.record_state <> 4
LEFT JOIN org_unit as ou on oup.org_unit_id = ou.id  and ou.record_state <> 4
LEFT JOIN cdn_position as pos on oup.position_id = pos.id  and pos.record_state <> 4
