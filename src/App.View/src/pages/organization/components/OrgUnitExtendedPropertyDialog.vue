        ...
        <q-form v-else @submit="onSubmit">
          <q-card-section class="q-pt-none">
            <f-select
              ...
              required
              :value="selectedOrgExtendedProperty"
              @input="onSelectOrgExtendedProperty"
              :options="orgExtendedProperties"
              optionLabel="name"
              optionValue="code"
              class="q-mb-md"
            />
...
<script>
import orgUnitExtendedPropertyDialog from '../mixins/orgUnitExtendedPropertyDialog'
export default {
  mixins: [orgUnitExtendedPropertyDialog],
}
</script>
