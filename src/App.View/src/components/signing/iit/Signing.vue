<template>
  <div>
    <q-dialog id="dialog" persistent v-model="visibleDialog">
      <q-card>
        <q-toolbar>
          <q-avatar>
              ...
              >
                <div :showing="!visiblePluginTransition">
                  ...
                  <div class="row items-center q-mt-md">
                    <q-btn flat @click="openSignJson">Показати файл, що підписується</q-btn>
                    <q-btn
                    ...
                    >
                      <template v-slot:loading>
                        <q-spinner-gears class="on-left" />{{registerLoadingLabel}}...
                      </template>
                    </q-btn>
                  </div>
                </div>
