...
namespace Core.Common.Helpers
{
    ...
    {
        private static Type[] EnumsCollection;
        ...
        public static IEnumerable<Type> EnumList
        {
            get
            {
                if (EnumsCollection == null)
                {
                    var assembly = AppDomain.CurrentDomain.GetAssemblies();
                    EnumsCollection = assembly
                        .SelectMany(t => t.GetTypes())
                        .Where(t => t.IsEnum && t.Namespace != null)
                        .ToArray();
                };
