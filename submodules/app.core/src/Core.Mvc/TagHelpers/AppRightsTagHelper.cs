...
namespace Core.Mvc.TagHelpers
{
    ...
    public class AppRightsTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var accessLevel = _userInfoService.GetCurrentUserInfo().GetFieldRight(Entity, property);
            // TODO: TEST CAREFULLY
            if (accessLevel == CrudOperation.None) {
                output.SuppressOutput();
            }
            else if ((accessLevel & CrudOperation.R) != 0) {
